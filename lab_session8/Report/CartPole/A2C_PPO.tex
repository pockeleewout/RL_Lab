...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{env\PYZus{}id} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{CartPole\PYZhy{}v1}\PY{l+s+s1}{\PYZsq{}}
\end{Verbatim}
\end{tcolorbox}
...
ActorCritic(
  (actor): BaseModel(
    (fc\_1): Linear(in\_features=4, out\_features=128, bias=True)
    (fc\_2): Linear(in\_features=128, out\_features=2, bias=True)
...
\PY{n}{N\PYZus{}TRIALS} \PY{o}{=} \PY{l+m+mi}{25}
\PY{n}{REWARD\PYZus{}THRESHOLD} \PY{o}{=} \PY{l+m+mi}{475}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Reached reward threshold in 101 episodes
    \end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{MAX\PYZus{}EPISODES} \PY{o}{=} \PY{l+m+mi}{1000}
\PY{n}{DISCOUNT\PYZus{}FACTOR} \PY{o}{=} \PY{l+m+mf}{0.99}
\PY{n}{N\PYZus{}TRIALS} \PY{o}{=} \PY{l+m+mi}{25}
\PY{n}{REWARD\PYZus{}THRESHOLD} \PY{o}{=} \PY{l+m+mi}{475}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Reached reward threshold in 523 episodes
    \end{Verbatim}
